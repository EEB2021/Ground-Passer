...
function App() {
    ...
    const rows =[
        ...
        {name: 'Chris', zeit: '01:00', anztreffer: 9, anzfehler: 1, anzpunkte: 200},
        {name: 'Tim', zeit: '01:00', anztreffer: 9, anzfehler: 1, anzpunkte: 200},
        {name: 'Max', zeit: '01:00', anztreffer: 9, anzfehler: 1, anzpunkte: 200},
        {name: 'Tom', zeit: '01:00', anztreffer: 9, anzfehler: 1, anzpunkte: 200},
    ]
    const rows2 = [
              ...
              {scores.map(scores =>{
                  return <Paper variant ="outlined" elevation={2}>
                        <div className="scoreCard">
                            ...
                            <div>
                                <div className="name"> {scores.anztreffer} </div>
                            </div>
                            <div>
                                <div className="name"> {scores.anzfehler} </div>
                            </div>
                            <div>
                                <div className="name"> {scores.punkte} </div>
                            </div>
                        </div>
                  </Paper>
              })}
